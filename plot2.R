...
##############################################################################
#
# Function: create_plot_2
#
# This function creates the second plot for the week 1 project in the Exploratory
