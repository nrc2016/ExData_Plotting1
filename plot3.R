...
# Filename: plot3.R
#
# This file contains the functions for creating the third plot for the week 1
...
##############################################################################
#
# Function: create_plot_3
#
# This function creates the thrid plot for the week 1 project in the Exploratory
